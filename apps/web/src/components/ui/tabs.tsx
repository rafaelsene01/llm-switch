...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-md bg-muted/60 p-1 text-muted-foreground border border-border/40",
      className
    )}
    {...props}
  />
